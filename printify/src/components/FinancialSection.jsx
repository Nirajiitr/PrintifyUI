...
const FinancialSection = () => {
  ...
  return (
    <div className="flex justify-center items-center w-full bg-white p-2 sm:p-4  lg:items-end lg:gap-0">
      <div ref={ref} className={`bg-[#203741] text-white rounded-3xl shadow-lg py-14 px-6 w-full max-w-lg m-5 sm:m-14 lg:m-0 ${ inView && "animate-sliderleft" }`}>
        <h2 className="text-2xl font-bold sm:mb-2">Make Money, Risk-Free</h2>
        <p className="text-sm mt-2 sm:my-4">
        ...
        <a
          className="withColorBtn inline-block sm:block text-center rounded w-full vsm:w-40 px-8 py-3 "
          href="#"
        >
          Start selling
        </a>
      ...
      <div className=" z-10 hidden lg:block ">
        <img src={girlImg} className="rounded-3xl w-full" alt="" />
      </div>
    </div>
  );
};
