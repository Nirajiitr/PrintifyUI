...
const WorkSection = () => {
  ...
  return (
    <div className="w-full px-4 mx-auto py-14 bg-[#f7f7f7] ">
      <div className="w-full flex flex-col lg:flex-row max-w-[552px] lg:max-h-[400px] lg:max-w-[1200px] mx-auto bg-white rounded-3xl relative ">
        ...
        <div className="static px-6 pt-8 pb-10  rounded-3xl bg-white">
          <div>
