  ...
  return (
    <div className='w-full px-4 mx-auto py-14 bg-[#f7f7f7]'>
      <div className=' flex flex-col items-center lg:flex-row py-32 px-6 lg:justify-center lg:items-center'>
        ...
        <p className='text-sm p-6 lg:w-1/3'>Whether you are just getting started or run an enterprise-level e-commerce business, we do everything we can to ensure a positive merchant experience.</p>
      </div>
